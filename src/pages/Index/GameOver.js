        ...
        <div className="bottom_div mx-auto">
          ...
          <div id="bottom_recommand" className="mx-auto">
            <div className="recommand_cards d-flex flex-column flex-xxl-row justify-content-center align-items-center">
              <Link
                to={`http://localhost:3000/game/${currentNum.img1}`}
              ...
              <Link
                to={`http://localhost:3000/game/${currentNum.img2}`}
                style={{ color: 'white', textDecoration: 'none' }}
                onClick={() => {
                  document.documentElement.scrollTop = 0
                }}
              >
                <div id="card2" className="card" style={{ cursor: 'pointer' }}>
                  <div className="card_content">
                    <img
                      className="box_img"
              ...
              <Link
                to={`http://localhost:3000/game/${currentNum.img3}`}
                style={{ color: 'white', textDecoration: 'none' }}
                onClick={() => {
                  document.documentElement.scrollTop = 0
                }}
              >
                <div id="card3" className="card" style={{ cursor: 'pointer' }}>
                  <div className="card_content">
                    <img
                      className="box_img"
